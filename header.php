								...
								<form action="#" method="get" class="form-search" accept-charset="utf-8">
									<div class="cat-wrap">
										<select name="category">
											<option hidden value="">Todos los departamentos</option>
									...
									<div class="box-search">
										<input type="text" name="search" placeholder="Buscar productos, marcar y más">
							...
							<div class="box-cart">
								...
								<div class="inner-box">
									...
									<div class="dropdown-box">
										...
										<div class="btn-cart">
											<a href="shop-cart.html" class="view-cart" title="">Ver carrito</a>
											<a href="shop-checkout.html" class="check-out" title="">Finalizar compra</a>
										</div>
									</div>
								</div><!-- /.inner-box -->
							</div><!-- /.box-cart -->
					...
					<div class="container">
						<div class="row">
							<div class="col-md-3 col-2">
								<div id="mega-menu">
									<div class="btn-mega"><span></span>DEPARTAMENTOS</div>
									<ul class="menu">
										<li>
							...
							<div class="nav-wrap">
								<div id="mainnav" class="mainnav">
									<ul class="menu">
										...
										<li class="column-1">
											<a href="shop.html" title="">Promociones</a>									
										</li><!-- /.column-1 -->
										<li class="column-1">
											<a href="#" title="">Vender</a>
										</li><!-- /.column-1 -->
								        ...
								        <li class="column-1">
                                            ...
                                            <ul class="submenu">
                                                ...
                                                <li>
                                                    <a href="wishlist.php" title="">Favoritos</a>
                                                </li>
                                                <li>
                                                    <a href="shop-cart.php" title="">Mi carrito</a>
                                                </li>
                                                <li>
                                                    <a href="shop-checkout.php" title="">Mis pedidos</a>
                                                </li>                                                
                                                 <li>
                                                    <a href="#" title="">Cerrar Sesión</a>
                                                </li>
                                            </ul>
								        </li>									
